...
The plugin is highly configurable and also allows caching of the urchin.js file locally, inorder to enable faster loading of pages.
...
* Highly configurable
* Includes support for local caching of urchin.js
...
1. `http://www.joycebabu.com/wp-content/uploads/2007/10/local-analytics.thumbnail.gif`