...
|	Shawn from Digital Point posted the YPN stuff here							|
...
|																				|
|	Modified by Joyce Babu <http://www.joycebabu.com/> to make the code			|
|	compatible with the latest Google Analytics Code.							|
|																				|
+-------------------------------------------------------------------------------+
*/
...
Modified by Joyce Babu <http://www.joycebabu.com/> to make the code compatible with the
latest Google Analytics Code.

******************************************************************************/

function ad_click () {
	pageTracker._trackPageview('<?php echo get_option('locan_ads_prefix');?>');
}
